...
public interface IRandomizer {
	/**
	 * Generates a random location point subject to the constraint that 0 LE X LErect.width and 0 LE Y LErect.height.
	...
	/**
	 * Generates a random location point subject to the constraint that 0 LE X LEdim.width and 0 LE Y LEdim.height.
	...
	/**
	 * Returns a random square Dimension, whose width is maxDim.width/2 LE width LEmaxDim.width
	 ...
	 * that x will be picked (0 LE x LE1).

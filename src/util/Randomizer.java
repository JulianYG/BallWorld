...
public class Randomizer implements IRandomizer {
	...
	/**
	 * Generates a random location point subject to the constraint that 0 LE X LE rect.width and 0 LE Y LE rect.height.
	...
	/**
	 * Generates a random location point subject to the constraint that 0 LE X LE dim.width and 0 LE Y LE dim.height.
	...
	/**
	 * Returns a random square Dimension, whose width is maxDim.width/2 LE width LE maxDim.width
	 ...
	 * that x will be picked (0 LE x LE 1).
